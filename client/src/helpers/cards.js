...
// render room card
function renderAttendingRooms(data) {
        ...
        <div key={room.id} className="col s12 m12 l6 animated fadeIn">
            <div className="card small">
                ...
                <div className="card-fab">
                    <a className="btn-floating halfway-fab waves-effect waves-light btn-large room-btn" onClick={() => enterRoom(room.name, room.id)}><ArrowRight size={24} /></a>
                </div>
